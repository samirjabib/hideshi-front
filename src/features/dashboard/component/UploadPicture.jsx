    ...
    return(
        <>
            <div className="grid grid-cols-1 md:grid-cols-4 p-6  ">
                <p className=" col-span-4 md:col-span-1  md:top-0  text-base ">Product Image</p>
                ...
                <div className="col-start-2 col-end-5  mt-4 text-center  border-2 border-black">
                        <h4 className={`${!!filesImg ? '' : 'hidden'} text-sm`}>Img Uploading</h4>
                    {
                        !!filesImg && filesImg.map( (file, index) => {
                            return(
                                <p 
                                key={index}
                                className='text-xs text-gray-600 border-2 border-black'
                                >
                                    {file.name}
                                </p>
                            )
