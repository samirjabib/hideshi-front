        ...
        <div className=" w-full p-4 md:flex md:justify-center h-screen">
            ...
            <div className=" h-full flex flex-col p-4  md:mt-16 md:ml-12">
                ...
                <div className="flex flex-col">   
                    ...
                    <option className="mt-8 flex flex-row w-10/12 md:w-full justify-between text-center uppercase my-4 font-medium gap-2 ">
                        ...
                        <button className="bg-bg_light_primary border border-black w-full  text-sm uppercase py-4 shadow mt-4 text-black transition-all duration-200 hover:bg-bg_dark_primary hover:text-bg_light_primary">CHECKOUT</button>
                </div>
